...
class SwinMAE(nn.Module, EncoderMixin):
    """
    ...
    def __init__(self, depth = 4, img_size: int = 224, patch_size: int = 4, mask_ratio: float = 0.75, in_channels: int = 49,
        ...
        self._out_channels = [in_channels, 256, 512, 1024, 1024]
    ...
    def init_weights(self):
        ...
        checkpoint_model = self.adapt_patch_embed_weights(checkpoint_model, target_in_ch)
