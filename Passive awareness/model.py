...
class SMPModel(pl.LightningModule):
    ...
    def configure_optimizers(self):
        params_group = [
            ...
            #{'params': self.texnet.decoder.parameters(), 'lr': self.args.lr},
            #{'params': self.texnet.segmentation_head.parameters(), 'lr': self.args.lr},
            # {'params': self.texnet.encoder.parameters(), 'lr': 2e-5},
        ]
