...
def main():
    ...
    with open(file_dir, "w") as file:
        ...
        for i in range(50, 100):
            ...
            model_path = f'/mnt/dqdisk/CODE/Tynew/TCIE/all/checkpoints2025-08-06T15:01:07.162250/model{i}.pth'
            ...
            # csv_path = './predictions_2physical_radiation.csv'
