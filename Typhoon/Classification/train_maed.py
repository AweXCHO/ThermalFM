...
class Config:
    ...
    batch_size = 64
    model_path = 'check_ablation_none/model_epoch48.pth'
...
def main():
    ...
    model = TCIC_swinmae_ablation(atm = False, pretrain_pth='/mnt/dqdisk/maeworkdir/checkpoints/swin-base-phy-fre-checkpoint-499.pth').to(device)
    
    if Config.model_pre is True:
        model.load_state_dict(torch.load(Config.model_path))

    folder_path = "./check_ablation_freq"
