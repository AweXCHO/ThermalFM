...
from models.network import mySimple
...
@MODELS.register_module(name='Single')
class Single(MonoDepthBaseModule):
    def __init__(self, opt):
        super().__init__(opt)
        self.save_hyperparameters()
        print(opt.model.ckpt_path)
        # model
        self.depth_net = mySimple(min_depth=opt.model.min_depth,\
