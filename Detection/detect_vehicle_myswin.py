...
if __name__ == '__main__':
    ...
    model = YOLO(model = r'runs/train/myswin_vehicle/exp/weights/best_fp32.pt')
    #model.load('/mnt/dqdisk/Code/ultralytics-yolo11-main/runs/train/dota/exp9/weights/best.pt') # select your model.pt path
    model.predict(source='/mnt/dqdisk/Data/vehicle/test/images',
                  imgsz=448,
                  rect=False,
                  project='inference/vehicle/myswin',
                  name='exp',
                  save=True,
                  conf=0.2,
                  iou=0.5,
